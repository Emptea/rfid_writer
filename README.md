...
Данный скрипт при чтении ответа на каждую команду выводит: протокол, количество переданных байт, количество принятых байт.
...
# Общение с меткой
Для корректного получения данных с метки в режиме Polling необходимо следующее:

- считать регистр 0x23;
- инициализировать общение по желаемому протоколу;
- включить RFID;
- считать;
- деинициализировать общение по протоколу;
- выключить RFID;

При желании две последних команды могут быть объединены в одну.

# Команды
## Считывание регистра 0x23
